...
public class QueryManager {
	 ...
	 */
	public static String getQueryPlan(String queryString) throws MalformedQueryException, FedXException, RepositoryException, QueryEvaluationException, RDFParseException {
