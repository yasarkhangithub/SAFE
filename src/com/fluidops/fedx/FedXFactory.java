...
public class FedXFactory {
	 ...
	 * @throws Exception
	 */
	public static SailRepository initializeFederation(String fedxConfig, List<Endpoint> additionalEndpoints) throws FedXException, RepositoryException, MalformedQueryException, QueryEvaluationException, RDFParseException, IOException {
