 ...
 *
 */
public class SAFESourceSelection_old {

	public static Logger log = Logger.getLogger(SAFESourceSelection_old.class);
	...
	public SAFESourceSelection_old(List<Endpoint> endpoints, Cache cache, QueryInfo queryInfo) {
...
//		System.out.println("All Graphs: " + allGraphs.size() + " === Selected Graphs: " + relevantGraphs.size());
	...
	protected static class SourceSelectionExecutorWithLatch implements ParallelExecutor<BindingSet> {
		 ...
		 * @param tasks
		 */
		public static void run(SAFESourceSelection_old sourceSelection, List<CheckTaskPair> tasks, Cache cache) {
			new SourceSelectionExecutorWithLatch(sourceSelection).executeRemoteSourceSelection(tasks, cache);
		}

		private final SAFESourceSelection_old sourceSelection;
		...
		private SourceSelectionExecutorWithLatch(SAFESourceSelection_old sourceSelection) {
	...
	protected static class ParallelCheckTask implements ParallelTask<BindingSet> {
		...
		public CloseableIteration<BindingSet, QueryEvaluationException> performTask() throws Exception {
			try {
				...
				SAFESourceSelection_old sourceSelection = control.sourceSelection;
